	...
	up: (queryInterface, Sequelize) => {
      ...
      */
				...
				},
				{
					...
					businessRating: 4,
					reviewText: "",
					videoLink: 'https://www.youtube.com/embed/M431LIlBuBI',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 5,
					reviewText: "Well deserved 5 star for quarantine delivery. I especially appreciated the careful wrapping of my kimchi stew, not one precious drop was lost. The beef gyoza was scrumptious. Bulgogi was tasty and tender. I'll jiji you if you jiji me, whatever that means.",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 5,
					reviewText: "Door Dashed Jijime last night and we thought the food was absolutely yummy. The highlight for me was the boneless chicken wing small plate; just the right amount of heat and crispiness to make me want to go back for more. The beef in the bulgogi plate was tender and well seasoned and the balance of acid and sweetness seemed just right to me. The small salad ($2) was mostly lettuce with a little tomato and radish thrown in and I really enjoyed the dressing.",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 4,
					reviewText: "I've only had one takeout order from Baiano, but I'll order from them again. I got a white pizza with shiitakes and truffle oil, and a Greek salad. Both were very good. Delivery (on a Saturday night, during COVID shelter in place) took about 45 minutes. The pizza is thin crust, and the ingredients tasted fresh. I like that there are several sizes to choose from, and the prices are decent. Only complaint is the crust was just ok--I think it would be better fresh out of the oven. As I said, I'll definitely give Baiano another try.",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 3,
					reviewText: "The pizza tastes good but i didn't really enjoy the service. The main person ( owner i guess) was not at all friendly and responded as if he wasn't willing to serve his customers. They're also messing up people's orders a lot, they messed up our pizza, the ones who were sitting right next to our too, and to add, they didn't mention they will take more time coz they messed up the order until we asked.",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					businessRating: 5,
					reviewText: "",
					videoLink: 'https://www.youtube.com/embed/ggNDfC4Kczo',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 5,
					reviewText: "This is our favorite Japanese restaurant in San Francisco and a hidden gem tucked away in Inner Sunset away from the tourist traps. It specializes in Japanese tapas (small plates), ramen, and unique small dishes. Dishes here are to share via family style with the exception of maybe the ramen (although you can order extra bowls).",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 5,
					reviewText: "I dream about their crab melt everyday. I also looove the way their Dutch Crunch roll is soft on the inside and crunchy on the outside. When I've had Dutch Crunch rolls in the past, they've scratched the inside of my mouth!\n\nI don't usually crave sandwiches, but this place was so good! The wait wasn't long, they are taking the proper precautions to protect against COVID- 19, and it's just so delicious. I can't wait to come back and try their other sandwiches",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 5,
					reviewText: "I'll argue with anyone that claims Ike's is better than Lou's. Lou's, in my opinion, is the reason they call San Francisco a sandwich mecca. The Dutch crunch bread is amazing, that goes without saying obviously, but the ingredients are fresh and the sandwiches are unlike any I've had at other places- the Hot Link? The Pomaikai? The combinations and layers of flavors transport me to places I didn't think a sandwich could take me. Like who knew Pastrami and Crab Salad would work so well together? For a sandwich to be outstanding, every component has to be perfect, and Lou's executes each piece of the filling and the bread to perfection. I highly recommend the Hot and Sweet and the Risky Business, but honestly?? It's all delicious. And you get your bang for your buck! I sometimes split each sandwich into two meals.\n\nOther things: The soda brand they carry, particularly the Ginger Beer, is amazing.It contains little pieces of ginger IN the soda and is the perfect drink to wash down after munching on a sandwich! ",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					downVoteCount: '0',
					businessRating: 3,
					reviewText: "Good sandwiches, messed up our order and they aren't very large, couldn't really make it two meals but i'd come back. I got the roma club and it was great, I'm not usually a pesto person but i'd recommend getting it, really makes the sandwich and is their \"secret sauce\"",
					videoLink: '',
					createdAt: new Date(),
					updatedAt: new Date()
				},
